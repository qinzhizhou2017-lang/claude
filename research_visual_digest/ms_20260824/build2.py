...
# 「上调指引」提及率的历史分位（Exhibit 11 行业热力图）
GUID = [("可选消费", 100.0), ("能源", 100.0), ("工业", 100.0), ("科技", 100.0),
        ("房地产", 94.4), ("医疗保健", 88.8), ("必需消费", 77.7), ("通信服务", 72.2),
        ("金融", 66.6)]


def guid_bars():
    return "\n          ".join(
        f'<div class="bar{" hl" if v >= 94 else ""}"><div class="nm"><b>{n}</b></div>'
        f'<div class="track"><div class="fill" style="width:{v:.0f}%"></div></div>'
        f'<div class="val">{v:.0f}</div></div>' for n, v in GUID)
  ...
  <div class="main">
    ...
    <div class="split">
      <div class="panel" style="padding:15px 17px;">
        ...
        <div class="panel-sub" style="margin-top:7px;">标普 500 中位数股票资本开支同比增速。从 2024 年三季度 1% 的谷底回到 <b>10%</b>；不过摩根士丹利指出，资本开支修正广度与"资本开支／销售额"因子都暗示，<b>增速的峰值可能就在不远处</b>。</div>
      ...
      <div class="panel" style="padding:15px 17px;">
        <div class="panel-t" style="font-size:13.5px;">上调指引：<span class="accent">四个行业顶到了满格</span></div>
        <div class="panel-sub" style="margin-top:7px;margin-bottom:9px;">"上调指引"提及率在各自历史区间中的分位（0–100）。可选消费、能源、工业、科技都触及历史最高区间，整体同样满格。</div>
        <div class="bars">
          {guid_bars()}
        </div>
        <div class="src">材料与公用事业的样本量不足，报告标注为 N/A。来源：AlphaSense、Morgan Stanley Research（Exhibit 11 行业热力图）。</div>
      </div>
    </div>
...
PAGES.append(f'''<section class="page">
  ...
  <div class="main">
    <div>
      ...
      <div class="kpirow">
        <div class="kpi"><div class="k">AI 提及率 历史分位</div><div class="v">88.8</div><div class="s">整体；11 个板块中<br><b>9 个 ≥ 88</b></div></div>
        <div class="kpi"><div class="k">上调指引 历史分位</div><div class="v g">100</div><div class="s">整体触及<br><b>历史最高区间</b></div></div>
        <div class="kpi"><div class="k">利润率压力 历史分位</div><div class="v" style="color:var(--red)">61.1</div><div class="s">材料 <b>100</b>、能源与<br>金融各 <b>72.2</b></div></div>
        <div class="kpi"><div class="k">"更高利率"历史分位</div><div class="v">0.0</div><div class="s">企业几乎不谈利率——<br>而<b>市场只盯着长端</b></div></div>
      </div>
    </div>
...
PAGES.append(f'''<section class="page">
  ...
  <div class="main">
    ...
    <div class="split" style="grid-template-columns:1fr 1fr;">
      <div class="panel" style="padding:15px 17px;">
        <div class="panel-t" style="font-size:13.5px;">K 的上半支：<span style="color:var(--green)">高端在加速</span></div>
    ...
    <div class="watch">
      ...
      <div class="wbox dn">
        ...
        <ul>
          ...
          <li>利润率压力历史分位 61.1，材料板块已<b>顶到 100</b></li>
