  ...
  <div class="main">
    ...
    <div class="split">
      <div class="panel" style="padding:15px 17px;">
        ...
        <div class="panel-sub" style="margin-top:8px;">摩根士丹利把 2027 年的 843 亿美元拆成两代产品：v8 卖 <b>31,154 台</b>机架、单价 170 万美元；v9 卖 <b>6,114 台</b>、单价 190 万美元（较 v8 溢价 10%）。功耗上 v8 每机架 83 千瓦（每颗芯片 1.3 千瓦），v9 每机架 96 千瓦（1.5 千瓦）。</div>
  ...
  <div class="main">
    <div>
      ...
      <div class="callout navy">
        <div class="q">400 美元的目标价，等于给 2027／2028 年平均 EPS <b>约 24 倍</b>——在增长调整后较同业溢价约 <b>20%</b>，而 Alphabet 目前只溢价约 5%。<b>要走到目标价，市场必须先愿意给它一个更高的倍数</b>，这件事 TPU 做不到，只有模型能做到。</div>
      </div>
    </div>
    ...
    <div class="panel" style="padding:14px 18px;">
      ...
      <div class="src">概率由 2026 年 8 月 21 日的期权隐含波动率估算，为风险中性概率。同业 2028 年市盈率中位数 18 倍（AAPL 29×、MSFT 18×、META 16×、AMZN 17×、NFLX 18×）。来源：Refinitiv、Morgan Stanley Research（Exhibit 6 / 7）。</div>
    </div>
